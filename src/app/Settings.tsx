    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Popup className="settings-dialog">
          ...
          >
            <Tabs.List className="settings-tablist" aria-label="Settings sections">
              {TABS.map((t) => (
                <Tabs.Tab key={t.id} value={t.id} className="settings-tab">
                  {t.label}
                </Tabs.Tab>
              ))}
            </Tabs.List>
            ...
            <div className="settings-body">
              <Tabs.Panel value="notebook" className="settings-panel">
                <Row
                  label="Notes folder"
                    ...
                    <CommitInput
                      ...
                      onCommit={(folder) =>
                        patch((s) => ({
                          ...
                          notebook: {
                            ...s.notebook,
                            dailyNote: { ...s.notebook.dailyNote, folder },
                          },
                        }))
                      }
                    />
              ...
              <Tabs.Panel value="appearance" className="settings-panel">
                {darkModeEnabled && (
                  <Row
                    label="Theme"
              ...
              <Tabs.Panel value="ai" className="settings-panel">
                <Row
                  label="AI features"
